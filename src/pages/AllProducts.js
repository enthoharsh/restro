        ...
        <div className="flex items-center">
          ...
          <div
            className={`relative w-8 h-4 rounded-full transition-colors duration-300 ${
              isVegOnly ? 'bg-green-200' : 'bg-gray-200'
            }`}
          ...
          >
            ...
            style={{
              ...
              className={`absolute w-4 h-4 rounded-full transition-transform duration-300 ${
                isVegOnly ? 'translate-x-5 bg-green-800' : 'translate-x-0 bg-black'
              }`}
            />
          </div>
        </div>
      ...
      <div className="flex overflow-x-auto shadow-md pb-2">
        {menuItems.map((category, index) => (
          ...
          style={{whiteSpace: 'nowrap'}}
            key={index}
            className={`m-1 rounded-[20px] w-auto p-2 py-1 ${
                index == selectedInd ? 'bg-black text-white' : 'text-gray-600'
            }`}
          >
            {category.title}
          </span>
